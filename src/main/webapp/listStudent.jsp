    ...
    <table class="table table-striped table-bordered table-hover table-condensed">
        ...
        <c:forEach items="${students}" var="s" varStatus="status">
            <tr>
                ...
                <td><a href="editStudent?id=${s.id}"><span class="glyphicon glyphicon-edit">edit</span> </a></td>
                <td><a href="deleteStudent?id=${s.id}"><span class="glyphicon glyphicon-trash">del</span> </a></td>
            </tr>
        </c:forEach>
